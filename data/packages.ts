...
export const packages: Package[] = [
  // Åre Packages
  {
    ...
    destination: 'are',
    images: [
      '/package-adventure.jpg', 
      '/package-adventure1.jpg', 
      '/package-adventure2.jpg', 
      '/package-adventure3.jpg',
    ],
    days: 7,
  ...
  {
    id: 'stockholm-pkg-3',
    title: 'Stockholm Christmas Week',
    location: 'Östermalm',
    destination: 'stockholm',
    images: [
      '/package-adventure.jpg', 
  ...
  {
    id: 'stockholm-pkg-4',
    title: 'Stockholm flottsbro ski spot',
    location: 'Djurgården',
    destination: 'stockholm',
    images: [
         '/package-stock-9.jpg', 
