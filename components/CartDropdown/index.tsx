...
const CartDropdown: React.FC<CartDropdownProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div
      ref={dropdownRef}
      className="absolute top-full right-0 mt-2 w-[calc(100vw-2rem)] sm:w-[380px] md:w-96 lg:w-96 bg-white rounded-lg shadow-lg border border-gray-200 z-[9999] max-h-[600px] flex flex-col"
    >
      {/* Header */}
      ...
      {cartItems.length === 0 ? (
        ...
        <>
          ...
          <div className="flex-1 overflow-y-auto p-2 sm:p-4 space-y-3 sm:space-y-4">
            {cartItems.map((item) => (
              <div key={item.id} className="flex gap-2 sm:gap-3 bg-gray-50 rounded-lg p-2 sm:p-3">
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <div className="font-bold text-[#C41E3A] text-xs sm:text-base whitespace-nowrap">
