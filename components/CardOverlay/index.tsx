...
const CardOverlay: React.FC = () => {
  ...
  return (
    <div className="relative w-screen h-screen flex items-center justify-center">
      {/* Cards Container */}
      <div className="absolute bottom-[5%] flex gap-5 max-md:flex-wrap max-md:justify-center sm:bottom-[-10%] md:bottom-[30%] max-[480px]:flex-col max-[480px]:items-center max-[480px]:bottom-[5] max-[480px]:mr-[15px]">
        {/* Left Card */}
