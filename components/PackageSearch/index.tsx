...
const PackageSearch: React.FC = () => {
  ...
  const handleSearch = () => {
    ...
    console.log('🔵 Find package holiday clicked!');
    ...
    const url = `/package?${params.toString()}`;
    console.log('🔵 Navigating to:', url);
    
    // Navigate to package listing page
    try {
      router.push(url);
    } catch (error) {
    ...
    <div className="bg-gray-100 py-4 sm:py-6">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-stretch lg:items-start gap-3 sm:gap-4">
          ...
          {/* Guests Dropdown */}
          <div className="w-full lg:flex-1 lg:min-w-[220px] relative" ref={guestsRef}>
            <button
              onClick={() => {
